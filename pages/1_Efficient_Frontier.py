...
Type in an existing ETF or upload a **daily price CSV file** with a `Date` column and ETF prices as other columns.
"""
)
...
if uploaded_file or st.session_state.use_input:
    # Load data
    if uploaded_file:
    ...
    # ---- Data Preview ----
    st.markdown("### Got ETF Price Data (First Five Rows)")
